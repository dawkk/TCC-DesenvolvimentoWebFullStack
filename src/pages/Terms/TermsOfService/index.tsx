            ...
            <Grid container direction="column" spacing={2}>
              ...
              <Grid item>
                <Typography variant="h6" component="h3">
                  Termos de Privacidade para Website La Cookeria
                </Typography>
              </Grid>
              <Grid item>
                ...
                <Typography variant="body1" component="p">
                  Estes Termos de Serviço regem a utilização do nosso website de entrega de alimentos. Ao utilizar nosso website,
              ...
              <Grid item>
                ...
                <Typography variant="body1" component="p">
                  Podemos atualizar estes Termos de Serviço periodicamente para refletir mudanças em nossas práticas ou requisitos legais.
                  Recomendamos que você reveja estes Termos de Serviço periodicamente para verificar se há atualizações.
                </Typography>
              </Grid>
              <Grid item>
                <Typography variant="body1" component="p">
